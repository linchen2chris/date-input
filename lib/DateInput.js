  ...
  _createClass(DateInput, [{
    ...
    value: function validate(dateValue) {
      var _props = this.props,
          ...
          minDateError = _props.minDateError,
          maxDateError = _props.maxDateError;

      var errorMsg = (0, _validator2.default)(dateValue, { minDate: minDate, maxDate: maxDate, invalidError: invalidError, minDateError: minDateError, maxDateError: maxDateError }, this.props.rules);
      if (errorMsg) {
    ...
    value: function onBlur(e) {
      ...
      setTimeout(function () {
        if (!currentTarget.contains(document.activeElement)) {
          if (_this2.props.shouldValidate) {
...
DateInput.propTypes = {
  ...
  shouldValidate: _propTypes2.default.bool,
