...
var DateInput = function (_Component) {
  ...
  _createClass(DateInput, [{
    ...
    value: function validate(dateValue) {
      if ((0, _moment2.default)(dateValue, 'YYYY-MM-DD', true).isValid()) {
        this.setState({ error: false });
      } else {
        this.setState({ error: true, errorMessage: 'please input a valid date' });
        return;
      }
      if (this.props.minDate && (0, _moment2.default)(dateValue).isBefore(this.props.minDate)) {
        this.setState({ error: true, errorMessage: 'the date can not before ' + this.props.minDate });
        return;
      }
      if (this.props.maxDate && (0, _moment2.default)(dateValue).isAfter(this.props.maxDate)) {
